...
# Loading data
data = np.genfromtxt('data-zero-one.csv', delimiter=',')
...
#Plotting the pdf
x = np.linspace(0.01, 140, 140)
P.plot(x, ivpdf(x, mean, scale), 'r-', lw=1.5, label='Inverse Gaussian pdf')

#Drawing histogram
n, bins, patches = P.hist(data, 40, normed=True, histtype='bar', alpha=0.2, label='Exit angles')
